...
export default function Component() {
  ...
  return (
    <div className="pt-[50px] relative w-full overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700" style={{ minHeight: 'calc(var(--vh, 1vh) * 100)' }}>
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        ...
        <Link to="/csgpt">
          <button className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-gray-700 bg-[linear-gradient(110deg,#1e2631,45%,#2c3644,55%,#1e2631)] bg-[length:200%_100%] px-6 font-medium text-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-900">
            Get Started
          </button>
        </Link>

        <div ref={subjectsRef} className="w-full max-w-4xl mx-auto mt-12 p-6 rounded-lg shadow-lg relative overflow-hidden bg-gray-800 bg-opacity-50">
          <div className="mb-12"><h3 className="text-4xl font-bold text-gray-100 px-3">SUPPORTED SUBJECTS</h3></div>  
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {subjects.map((subject, index) => (
              <div key={index} className="relative group h-24">
                ...
                <div className="relative h-full px-4 py-3 bg-gray-800 ring-1 ring-gray-700 rounded-lg leading-none flex items-center justify-center">
                  <p className="text-gray-200 group-hover:text-white transition duration-200 text-sm">{subject}</p>
        ...
        <section className="relative z-10 py-16 px-4 text-center">
          <h2 className="mb-10 text-4xl font-bold text-gray-100">Key Features</h2>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={index} className="rounded-lg bg-gray-800 bg-opacity-50 p-8 shadow-lg transition-all hover:bg-opacity-70 hover:shadow-xl transform hover:-translate-y-1">
                {feature.icon}
                <h3 className="mb-3 text-2xl font-semibold text-gray-200">{feature.title}</h3>
        ...
        <section className="relative z-10 py-16 px-4 text-center bg-gray-800 bg-opacity-50 rounded-lg shadow-2xl max-w-4xl mx-auto">
          <h2 className="mb-6 text-4xl font-bold text-gray-100">About CSGPT</h2>
        ...
        <section className="relative z-10 py-16 px-4 text-center">
          <h2 className="mb-10 text-4xl font-bold text-gray-100">User Feedback</h2>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="rounded-lg bg-gray-800 bg-opacity-50 p-6 shadow-lg transition-all hover:bg-opacity-70 hover:shadow-xl">
                <p className="text-gray-200 mb-4">"{feedback.comment}"</p>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">{feedback.name}</span>
                  <div className="flex">
        ...
        <section className="relative z-10 py-16 px-4 text-center">
          <h2 className="mb-6 text-4xl font-bold text-gray-100">Ready to Get Started?</h2>
          <p className="mb-8 text-lg text-gray-200">Join thousands of satisfied users and experience the future of search technology.</p>
          <button className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-gray-700 bg-[linear-gradient(110deg,#1e2631,45%,#2c3644,55%,#1e2631)] bg-[length:200%_100%] px-8 font-medium text-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-900 text-lg">
            <Link to="/csgpt">Try CSGPT Now</Link>
          </button>
        </section>

        <section className="relative z-10 py-16 px-4 text-center max-w-2xl mx-auto">
          <h2 className="mb-6 text-4xl font-bold text-gray-100">Leave Your Feedback</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 rounded-md bg-gray-700 bg-opacity-50 text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full h-12 animate-shimmer items-center justify-center rounded-md border border-gray-700 bg-[linear-gradient(110deg,#1e2631,45%,#2c3644,55%,#1e2631)] bg-[length:200%_100%] px-8 font-medium text-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-900"
            >
              Submit Feedback
            </button>
          </form>
