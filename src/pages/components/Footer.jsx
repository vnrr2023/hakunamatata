      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <nav className="flex flex-wrap justify-center sm:justify-start gap-6 mb-4 sm:mb-0">
            ...
            <Link to="https://github.com/csgpt-ai" target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 transition-colors">
            ...
            <Link to="https://linkedin.com/company/csgpt-ai" target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 transition-colors">
              <span className="flex items-center">
                <svg className="h-5 w-5 mr-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
